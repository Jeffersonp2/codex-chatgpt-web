...
const port = envPort("CODEX_WEB_PROVIDER_PORT", 11435);
const upstreamBase = `http://${config.host}:${config.port}`;
const providerKey = process.env.CODEX_WEB_PROVIDER_API_KEY?.trim();
